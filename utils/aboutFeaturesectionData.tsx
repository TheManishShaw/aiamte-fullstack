import { CoalesceIcon } from "@/public/icons/icons";

export const aboutFeatureSectionData = [
  {
    id: 1,
    title: "Coalesce",
    paragraph:
      " We forge strong partnerships with healthcare data providers,consolidating our resources and expertise to fortify our firm's security measures",
    icon: (
  ...
  },
  {
    ...
    paragraph:
      " This crucial process meticulously removes all personal identifiers from the data, while ensuring the preservation of essential DICOM entities and radiology information.",
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
  ...
  },
  {
    ...
    paragraph:
      " Our team of radiologists conducts rigorous quality checks on the data before it is integrated into our delivery system, ensuring utmost accuracy and reliability.",
    icon: (
  ...
  },
  {
    ...
    title: "Data Delivery",
    paragraph:
      " Our proficient team, well-versed in handling sensitive information, consolidates the data and its metadata into a single repository, conducting a final check before securely delivering it to you",
    icon: (
      <svg
