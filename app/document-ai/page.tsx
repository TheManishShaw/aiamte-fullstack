...
const DocAi = () => {
  return (
    <>
      ...
      {/* <section
        id="features"
        className="container mx-auto px-4 space-y-6 text-base font-medium leading-relaxed text-body-color py-8 dark:bg-transparent md:py-12 lg:py-20"
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-7">
      ...
      <section className="container mx-auto text-base font-medium leading-relaxed text-body-color mt-8 p-8 bg-transparent shadow-lg rounded-lg">
        ...
        <p className=" mb-6">
          ...
          automates the processing and analysis of documents. Aimate offers
          various types of Document AI services to meet your needs.
        </p> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex items-center">
            <img
              src="/images/services/image-reco.jpg"
          ...
          <div>
            ...
            <ul className="list-disc pl-8">
              ...
              <li>Text and data extraction</li>
              <li>Accuracy and data validation</li>
            </ul>
          </div>
