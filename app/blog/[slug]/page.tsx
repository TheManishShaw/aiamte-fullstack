...
import { getBlogs, getSingleBlog } from "@/sanity/actions";
...
const page = async ({ params: { slug } }: { params: { slug: string } }) => {
  ...
  const date = format(new Date(blogData?._createdAt), "dd-MMM-yyyy");
            ...
            <div>
                  ...
                  <div className="mr-10 mb-5 flex items-center">
                    <div className="mr-4">
                      <div className="relative h-10 w-10 overflow-hidden rounded-full">
                        <Image src={blogData?.authorImg} alt="author" fill />
                      </div>
                    </div>
                    <div className="w-full">
                      <h4 className="mb-1 text-base font-medium text-body-color">
                        By{" "}
                        <span>
                          {blogData?.author ? blogData?.author : "Aimate User"}
                        </span>
                      </h4>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="text-base font-medium leading-relaxed text-body-color">
                  <PortableText value={blogData?.description} />
                </div>
                ...
                <div className="items-center justify-between sm:flex">
                  <div className="mb-5">
                    ...
                    <div className="flex items-center">
                      {blogData?.popularTags ? (
                        <TagButton text={blogData?.popularTags} />
                      ) : (
                        ""
                      )}
            ...
            <div className="mt-12 mb-10 rounded-md bg-primary bg-opacity-5 p-6 dark:bg-opacity-5 lg:mt-0">
              <form className="flex items-center justify-between">
                <input
                  ...
                  className="placeholder-body-color mr-5 w-full rounded-md border border-transparent py-3 px-5 text-base font-medium text-body-color outline-none focus:border-primary dark:bg-white dark:bg-opacity-10"
                />
                ...
                {blogs.map((blog: any) => (
                  <li className="mb-6 border-b border-body-color border-opacity-10 pb-6 dark:border-white dark:border-opacity-10">
                    <RelatedPost
                      ...
                      image={blog.image}
                      slug={`/blog/${blog?._id}`}
                      date={format(new Date(blog?._createdAt), "dd-MMM-yyyy")}
                    />
                  </li>
                ))}
              </ul>
